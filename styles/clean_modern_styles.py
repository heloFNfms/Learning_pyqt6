...
QTableWidget {
    ...
    font-size: 14px;
    alternate-background-color: rgba(248, 249, 250, 200);
}
...
QTableWidget::item:selected {
    background: qlineargradient(x1:0, y1:0, x2:1, y2:0,
                stop:0 rgba(102, 126, 234, 80), stop:1 rgba(118, 75, 162, 80));
    color: #333;
}
...
QLineEdit, QDoubleSpinBox, QSpinBox, QDateEdit {
    background: rgba(255, 255, 255, 220);
    border: 2px solid rgba(116, 185, 255, 80);
    border-radius: 8px;
    padding: 12px 16px;
    font-size: 14px;
    color: #333;
...
QLineEdit, QDoubleSpinBox, QSpinBox, QDateEdit {
    background: rgba(255, 255, 255, 220);
    border: 2px solid rgba(252, 182, 159, 120);
    border-radius: 8px;
    padding: 12px 16px;
    font-size: 14px;
    color: #333;
